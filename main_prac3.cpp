...
{
	GLfloat vertice[8][3] = {
				{1.0 ,-1.0, 1.0},    //Coordenadas Vértice 0 V0
				{-1.0 ,-1.0, 1.0},    //Coordenadas Vértice 1 V1
				{-1.0 ,-1.0, -1.0},    //Coordenadas Vértice 2 V2
				{1.0,-1.0, -1.0},    //Coordenadas Vértice 3 V3
				{1.0 ,1.0, 1.0},    //Coordenadas Vértice 4 V4
				{1.0 ,1.0, -1.0},    //Coordenadas Vértice 5 V5
				{-1.0 ,1.0, -1.0},    //Coordenadas Vértice 6 V6
				{-1.0 ,1.0, 1.0},    //Coordenadas Vértice 7 V7
	};
